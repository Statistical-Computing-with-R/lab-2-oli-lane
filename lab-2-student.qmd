...
```
  ...
  There are 30463 rows and 15 columns
...
Based on the calculated p-value of <2e-16 (far less than 0.05), we accept the alternative hypothesis and reject the null hypothesis that the population mean weight is the same between all fourteen rodent species. This means that **At least one** rodent species has a different population mean weight.
...
## References
- 1 : https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/nrow
- 2 : https://www.codecademy.com/resources/docs/r/built-in-functions/str
- 3 : https://ggplot2.tidyverse.org/reference/aes_colour_fill_alpha.html
- 4 : http://www.sthda.com/english/wiki/ggplot2-axis-ticks-a-guide-to-customize-tick-marks-and-labels
- 5 : ?aov r documentation
